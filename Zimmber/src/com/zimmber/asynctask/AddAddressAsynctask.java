...
public class AddAddressAsynctask extends AsyncTask<String, Void, String> {

	Activity activity;
	public AddAddressInterface addaddressintf;

	String email = "", access_token = "", address_title = "", state_id = "", city_id = "",
			location_id = "", landmark = "", street = "", flat_no = "",
			address = "", pincode = "";
	...
	public AddAddressAsynctask(Activity activity) {
	...
	protected String doInBackground(String... args) {
		...
		try {
			...
			Log.d("updateProfile", addAddress.toString());
	...
	protected void onPostExecute(String jsonStr) {
		...
		addaddressintf.onCompletedAddAddress(errorcode, message);
	...
	protected void onPreExecute() {
		// TODO Auto-generated method stub
		super.onPreExecute();
		addaddressintf.onStartedAddAddress();
