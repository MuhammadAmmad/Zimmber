...
public class ForgotPasswordAsynctask extends AsyncTask<String, Void, String> {
	...
	Activity activity;
	public ForgotPasswordInterface forgotpasswordintf;
	...
	public ForgotPasswordAsynctask(Activity activity) {
	...
	protected String doInBackground(String... args) {
		...
		String url = NetworkUtil.forgotpasswordUrl;
		...
		try {
			...
			forgotPassword.put("forgotPassword", jsonObject);

			DefaultHttpClient httpClient = new DefaultHttpClient();
			HttpPost httpPost = new HttpPost(url);
			List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();
			nameValuePairs.add(new BasicNameValuePair("data", forgotPassword
					.toString()));
	...
	protected void onPostExecute(String jsonStr) {
		...
		forgotpasswordintf.onCompletedForgotPassword(errorcode, message);
	...
	protected void onPreExecute() {
		// TODO Auto-generated method stub
		super.onPreExecute();
		forgotpasswordintf.onStartedForgotPassword();
