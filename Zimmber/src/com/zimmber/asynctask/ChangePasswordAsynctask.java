...
public class ChangePasswordAsynctask extends AsyncTask<String, Void, String> {
	...
	Activity activity;
	public ChangePasswordinterface changepasswordintf;
	...
	public ChangePasswordAsynctask(Activity activity) {
	...
	protected String doInBackground(String... args) {
		...
		String url = NetworkUtil.changePasswordUrl;
		...
		try {
			...
			jsonObject.put("oldPass", password);
			jsonObject.put("newPass", new_password);

			JSONObject changePassword = new JSONObject();
			changePassword.put("changePassword", jsonObject);

			DefaultHttpClient httpClient = new DefaultHttpClient();
			HttpPost httpPost = new HttpPost(url);
			List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();
			nameValuePairs.add(new BasicNameValuePair("data", changePassword
					.toString()));
	...
	protected void onPostExecute(String jsonStr) {
		...
		changepasswordintf.onCompletedChangePassword(errorcode, message);
	...
	protected void onPreExecute() {
		// TODO Auto-generated method stub
		super.onPreExecute();
		changepasswordintf.onStartedChangePassword();
